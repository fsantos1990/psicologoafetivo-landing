...
// (mantém seus artigos; este arquivo não gerencia mais navegação; links apontam para /blog/*.html)
...
export default function App() {
  ...
  useSeoMetadata(
    "Psicólogo Online Afetivo | Terapia de Casal e Individual (ACT/IBCT)",
    "Felipe Santos, Psicólogo Afetivo (CRP 03/15591). Especialista em terapia de casal e individual online. Agende sua teleconsulta.",
  ...
  return (
    <div className="min-h-screen bg-black text-white font-inter">
      ...
      <main>
        ...
        {/* (Opcional) Cards de últimos posts dentro da Home com links estáticos */}
