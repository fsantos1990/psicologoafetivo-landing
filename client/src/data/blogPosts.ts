...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>
        ...
        Não se trata de "esvaziar a mente", mas de perceber que você é maior do que aquilo que pensa.
      </p>
      <p>
        ...
        estiveram a serviço desses valores?".
      </p>
      <h2>Quando buscar ajuda profissional</h2>
      <p>
        Se a ansiedade tem limitado de forma consistente sua vida social, familiar ou profissional, pode ser o momento
        de procurar acompanhamento psicoterapêutico. A ACT oferece um caminho para reconstruir a relação consigo mesmo
        com mais gentileza e direção, sem prometer uma vida sem medo, mas uma vida em que o medo deixa de ser o centro
  ...
  },
  {
    ...
    content: `
      ...
      <p>
        ...
        crenças sobre valor próprio e modelos de amor herdados da família e da cultura.
      </p>
      <p>
  ...
  },
  {
    ...
    excerpt:
      "Sinais de que está na hora de pedir ajuda, mitos comuns sobre terapia de casal e como se preparar para o primeiro encontro.",
